            ...
            <div class="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
                <form @submit.prevent="handleSubmit">
                    ...
                    <div class="mb-4">
                        ...
                        <select
                        v-model="form.type"
                        id="type" name="type" class="border rounded w-full py-2 px-3" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input
                        v-model="form.title"
                        type="text" id="name" name="name" class="border rounded w-full py-2 px-3 mb-2"
                    ...
                    <div class="mb-4">
                        ...
                        id="description" name="description" class="border rounded w-full py-2 px-3" rows="4"
                    ...
                    <div class="mb-4">
                        ...
                        <select
                        v-model="form.salary"
                        id="salary" name="salary" class="border rounded w-full py-2 px-3" required>
                    ...
                    <div class="mb-4">
                        ...
                        type="text" id="location" name="location" class="border rounded w-full py-2 px-3 mb-2"
                    ...
                    <div class="mb-4">
                        ...
                        type="text" id="company" name="company" class="border rounded w-full py-2 px-3"
